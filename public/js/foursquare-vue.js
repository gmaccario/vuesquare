...
const FSCurrentLocation = Vue.component('fs-current-location',{
	...
	methods: {
		/**
    	 * @name setWhereIAm
    	 * @description Ask to Foursquare for more precise info on where the user is located.
    	 */
		setWhereIAm() {
  	...
  	template:`  	
  		<div class="wrapper current-location">
		  	...
		  	<p>You are in NYC’s Greenwich Village. Here your precise location:</p>
		  	<ul>
		  		...
		  		<li><span class="label">Accuracy: </span><span class="value">&asymp; {{ config.accuracy }} meters</span></li>
		  	</ul>
  		</div>`
});
